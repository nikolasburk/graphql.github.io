...
### JavaScript
  ...
  - [graphql-request](https://github.com/graphcool/graphql-request): As simple and lightweight JavaScript GraphQL client that works in all JavaScript environments - the browser, Node.js, and React Native.
